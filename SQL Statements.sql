...
INSERT INTO Customer (FirstName, LastName, Street, City, State, ZipCode, PhoneNumber, Email)
    VALUES ('Alex', 'Kim', '64 Country Village Ln.', 'Herricks', 'NY', '11590', '1-516-202-3953', 'akim67@gmail.com');

INSERT INTO Customer (FirstName, LastName, Street, City, State, ZipCode, PhoneNumber, Email)
    VALUES ('Samantha', 'Gadze', '154 Colonial Blvd.', 'Providence', 'RI', '02860', '1-401-791-5053', 'samgadze@gmail.com');

INSERT INTO Customer (FirstName, LastName, Street, City, State, ZipCode, PhoneNumber, Email)
    VALUES ('Pranshu', 'Babber', '4 Emmet St.', 'Denton', 'NY', '11590', '1-613-351-1517', 'pbab@gmail.com');

INSERT INTO Customer (FirstName, LastName, Street, City, State, ZipCode, PhoneNumber, Email)
    VALUES ('Rebecca', 'Kim', '72 Sunset Dr.', 'Albertson', 'NY', '11596', '1-516-900-1691', 'rebbyk98@gmail.com');

INSERT INTO Customer (FirstName, LastName, Street, City, State, ZipCode, PhoneNumber, Email)
    VALUES ('Daniel', 'Jun', '14 Denton Ave.', 'Stony Brook', 'NY', '11733', '1-613-765-1964', 'habeen17@gmail.com');

INSERT INTO Customer (FirstName, LastName, Street, City, State, ZipCode, PhoneNumber, Email)
    VALUES ('Joe', 'D''Arpino', 'Mulbery Dr.', 'Boston', 'MA', '02109', '1-617-429-7034', 'joseph.darpino@bu.edu');

INSERT INTO Customer (FirstName, LastName, Street, City, State, ZipCode, PhoneNumber, Email)
    VALUES ('Mohamed', 'Sihly', '603 Foch Blvd.', 'Williston Park', 'NY', '11596', '1-516-765-6876', 'mohamed.sihly@baruchmail.cuny.edu');
